...
//! |---|---|---|
//! | `punch::Carrier` | [`PeerCarrier`] | `offer` / `collect` at the node, over `remote::send_execute` |
...
use entity_signaling::punch::{self, Carrier, PunchError, PunchIo, PunchParty};
...
// ---------------------------------------------------------------------------
// The carrier — offer/collect at the node
// ---------------------------------------------------------------------------
